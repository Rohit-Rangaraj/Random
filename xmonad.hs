...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_s), AL.launchApp def "spotify")
    ...
    -- Cycle WS
    , ((modm, 	xK_Down), moveTo Prev HiddenNonEmptyWS)
    , ((modm, 	xK_Up), moveTo Next HiddenNonEmptyWS)
...
myStartupHook = do
  ...
  spawnOnce "feh --bg-scale ~/Downloads/ArchWaveBlue.png"
  spawnOnce "picom -f"
